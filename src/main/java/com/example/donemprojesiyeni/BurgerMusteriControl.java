...
public class BurgerMusteriControl {
    ...
    public void fillData(ObservableList<data> dList){
        ...
        for(data d : dList){
           ...
           // box.setMaxSize(Double.MAX_VALUE, Double.MAX_VALUE);
            ...
            box.setStyle("-fx-border-color: #ffffff; -fx-border-width : 2px; ");

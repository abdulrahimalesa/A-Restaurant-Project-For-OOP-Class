...
public class EvYemekControl {
    ...
    @FXML
    private TextField yemekAdi;

    @FXML
    private TextField yemekAciklama;


    @FXML
    private TextField yemekFiyat;
    ...
    public void initialize() {
        ...
        ObservableList<data> dList = service.Okumak("yemek");
    ...
    public void fillData(ObservableList<data> dList){
        ...
        for(data d : dList){
            ...
            sil.setOnAction(event -> {
                Dosyaİslemleri service = new Dosyaİslemleri();
                service.silme("yemek", finalIndex+1);
                dataList.getChildren().clear();
                fillData(service.Okumak("yemek"));
            });
    ...
    @FXML
    void yemekKaydet(ActionEvent event){
        data d = new data(yemekAdi.textProperty(), yemekAciklama.textProperty(), yemekFiyat.textProperty());

        Dosyaİslemleri service = new Dosyaİslemleri();
        service.kaydet(d, "yemek");
    ...
    @FXML
    void evyemekEkle(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/donemprojesiyeni/evyemekekle.fxml"));

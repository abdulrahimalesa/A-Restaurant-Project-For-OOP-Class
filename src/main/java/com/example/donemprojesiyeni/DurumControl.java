...
public class DurumControl {
    ...
    @FXML
    private TextField dorumAdi;

    @FXML
    private TextField dorumAciklama;

    @FXML
    private TextField dorumFiyat;
    ...
    public void initialize() {
        ...
        ObservableList<data> dList = service.Okumak("dorum");
    ...
    public void fillData(ObservableList<data> dList){
        ...
        for(data d : dList){
            ...
            sil.setOnAction(event -> {
                Dosyaİslemleri service = new Dosyaİslemleri();
                service.silme("dorum", finalIndex+1);
                dataList.getChildren().clear();
                fillData(service.Okumak("dorum"));
            });
    ...
    @FXML
    void dorumKaydet(ActionEvent event){
        data d = new data(dorumAdi.textProperty(), dorumAciklama.textProperty(), dorumFiyat.textProperty());

        Dosyaİslemleri service = new Dosyaİslemleri();
        service.kaydet(d, "dorum");

        closeStage(event);
    }

    @FXML
    void dorumEkle(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/donemprojesiyeni/durumekle.fxml"));

...
public class IcecekControl {
    ...
    @FXML
    private TextField icecekAdi;

    @FXML
    private TextField icecekAciklama;

    @FXML
    private TextField icecekFiyat;
    ...
    public void initialize() {
        ...
        ObservableList<data> dList = service.Okumak("icecek");
    ...
    public void fillData(ObservableList<data> dList){
        ...
        for(data d : dList){
            ...
            sil.setOnAction(event -> {
                Dosyaİslemleri service = new Dosyaİslemleri();
                service.silme("icecek", finalIndex+1);
                dataList.getChildren().clear();
                fillData(service.Okumak("icecek"));
            });
    ...
    @FXML
    void icecekKaydet(ActionEvent event){
        data d = new data(icecekAdi.textProperty(), icecekAciklama.textProperty(), icecekFiyat.textProperty());

        Dosyaİslemleri service = new Dosyaİslemleri();
        service.kaydet(d, "icecek");

        closeStage(event);
    }

    @FXML
    void icecekEkle(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/donemprojesiyeni/icecekekle.fxml"));

...
public class BurgerControl {
    ...
    @FXML
    private TextField burgerAdi;

    @FXML
    private TextField burgerAciklama;

    @FXML
    private TextField burgerFiyat;
    ...
    public void initialize() {
        ...
        ObservableList<data> dList = service.Okumak("burger");
    ...
    public void fillData(ObservableList<data> dList){
        ...
        for(data d : dList){
            ...
            sil.setOnAction(event -> {
                Dosyaİslemleri service = new Dosyaİslemleri();
                service.silme("burger", finalIndex+1);
                dataList.getChildren().clear();
                fillData(service.Okumak("burger"));
            });
    ...
    @FXML
    void burgerKaydet(ActionEvent event){
        data d = new data(burgerAdi.textProperty(), burgerAciklama.textProperty(), burgerFiyat.textProperty());

        Dosyaİslemleri service = new Dosyaİslemleri();
        service.kaydet(d, "burger");

        closeStage(event);
    }

    @FXML
    void burgerEkle(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/donemprojesiyeni/burgerekle.fxml"));
